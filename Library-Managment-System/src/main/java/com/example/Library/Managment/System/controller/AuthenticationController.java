...
public class AuthenticationController {
    ...
    public ResponseEntity<LoginResponse> loginStudent(@RequestBody LoginRequest loginRequest) {
        LoginResponse loginStudent = authenticationService.loginStudent(loginRequest);
        HttpStatus status = loginStudent.getId() != null ? HttpStatus.OK : HttpStatus.UNAUTHORIZED;
